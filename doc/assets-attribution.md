The following is a list of assets used in the clinton source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://clintontalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original clinton logo from Bitboy)
* License: MIT
