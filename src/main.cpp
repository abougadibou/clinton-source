...
const string strMessageMagic = "Clinton Signed Message:\n";
...
int64 GetBlockValue(int nHeight, int64 nFees)
{
    int64 nSubsidy = 1 * COIN;
            ...
            if(nHeight == 1)
            {
            nSubsidy = 799005 * COIN;
            }

    // Subsidy is cut in half every 811111 blocks
    nSubsidy >>= (nHeight / Params().SubsidyHalvingInterval());

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 120 * 60;
